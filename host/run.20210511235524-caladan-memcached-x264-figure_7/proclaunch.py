...
def launch_shenango_program(cfg, experiment):
    print("in function{}".format("launch_shenango_program"))
    assert 'args' in cfg
    ...
    print("in function{} {} {}".format("launch_shenango_program", "gen_conf", "{}/{}.config".format(experiment['name'], cfg['name'])))
    gen_conf(
