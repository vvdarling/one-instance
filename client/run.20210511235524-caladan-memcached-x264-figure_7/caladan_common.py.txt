...
def new_storage_server(threads, experiment, **kwargs):
    ...
    x = {
        ...
        'transport': 'tcp',
        'system': system,
        'custom_conf': ["enable_storage 1"]#hzw , "enable_directpath 1"]
...
def storage(cores, experiment, mpps=None, **kwargs):
    ...
    ch = new_measurement_instances(1, l, mpps, experiment, nconns=400, client_list=[CLIENT_NAME_201], mean=16, distribution=dist, start_mpps=start_mpps)
    return l, ch
